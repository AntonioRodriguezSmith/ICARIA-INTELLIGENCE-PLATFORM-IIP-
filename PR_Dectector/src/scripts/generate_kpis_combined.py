...
MD_INPUT = r"data/reglas/ejemplos_revisados/ejemplos_validacion.md"
JSON_SUM = r"data/reglas/ejemplos_revisados/ejemplos_validacion_summary.json"
OUT_MD = r"data/reglas/Kpis/kpis_combined.md"
OUT_CSV = r"data/reglas/Kpis/kpis_combined.csv"
